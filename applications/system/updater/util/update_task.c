...
static const char* update_task_stage_descr[] = {
    ...
    [UpdateTaskStageReadManifest] = "cargando manifest",
    [UpdateTaskStageValidateDFUImage] = "comprobando DFU",
    [UpdateTaskStageFlashWrite] = "escribiendo memoria",
    [UpdateTaskStageFlashValidate] = "validando memoria",
    [UpdateTaskStageRadioImageValidate] = "Checking radio FW",
    [UpdateTaskStageRadioErase] = "borrando radio FW",
    [UpdateTaskStageRadioWrite] = "escribiendo radio FW",
    [UpdateTaskStageRadioInstall] = "instalando radio FW",
    [UpdateTaskStageRadioBusy] = "Core 2 ocupado",
    [UpdateTaskStageOBValidation] = "Validating bytes",
    [UpdateTaskStageLfsBackup] = "respaldando LFS",
    [UpdateTaskStageLfsRestore] = "Restaurando LFS",
    [UpdateTaskStageResourcesUpdate] = "actualizando recursos",
    [UpdateTaskStageSplashscreenInstall] = "instalando splash",
    [UpdateTaskStageCompleted] = "Reiniciando",
...
static const struct {
...
} update_task_error_detail[] = {
    {
        ...
        .percent_min = 0,
        .percent_max = 13,
        .descr = "actualizador de hw incorrecto",
    },
    {
        .stage = UpdateTaskStageReadManifest,
        .percent_min = 14,
        .percent_max = 20,
        .descr = "error del manifest",
    },
    {
        .stage = UpdateTaskStageReadManifest,
        .percent_min = 21,
        .percent_max = 30,
        .descr = "error de carga",
    },
    {
        .stage = UpdateTaskStageReadManifest,
        .percent_min = 31,
        .percent_max = 40,
        .descr = "paquete incorrecto",
    },
    {
        .stage = UpdateTaskStageReadManifest,
        .percent_min = 41,
        .percent_max = 50,
        .descr = "hw objetivo incorrecto",
    },
    {
        .stage = UpdateTaskStageReadManifest,
        .percent_min = 51,
        .percent_max = 60,
        .descr = "archivo de DFU faltante",
    },
    {
        .stage = UpdateTaskStageReadManifest,
        .percent_min = 61,
        .percent_max = 80,
        .descr = "archivo de radio faltante",
    },
...
#else
    {
        ...
        .percent_min = 0,
        .percent_max = 98,
        .descr = "error de lectura",
    },
    {
        .stage = UpdateTaskStageRadioImageValidate,
        .percent_min = 99,
        .percent_max = 100,
        .descr = "crc no coincidente",
    },
    {
