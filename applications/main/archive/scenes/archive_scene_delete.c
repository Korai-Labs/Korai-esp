...
void archive_scene_delete_on_enter(void* context) {
    ...
    widget_add_button_element(
        app->widget, GuiButtonTypeLeft, "Cancelar", archive_scene_delete_widget_callback, app);
    widget_add_button_element(
        app->widget, GuiButtonTypeRight, "Borrar", archive_scene_delete_widget_callback, app);
    ...
    char delete_str[64];
    snprintf(delete_str, sizeof(delete_str), "\e#Borrar %s?\e#", furi_string_get_cstr(filename));
